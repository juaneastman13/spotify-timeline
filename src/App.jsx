      ...
      <div style={S.wrap}>
        ...
        {phase === "listen" && (
          <div style={{ ...S.card, textAlign: "center", animation: "fadeIn .4s both" }}>
            ...
            <a href={spotifyLink} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "14px 32px", background: G, color: "#000", borderRadius: 50, fontSize: 16, fontWeight: 800, textDecoration: "none", textTransform: "uppercase", letterSpacing: ".06em", animation: "glow 2s infinite" }}>
